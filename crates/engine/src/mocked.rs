...
impl TextStyle {
	...
	pub fn add_font_feature(
		&mut self,
		_font_feature: impl AsRef<str>,
		_value: i32,
	) {
		unimplemented!("This is mocked")
	}
	...
	pub fn set_typeface(
		&mut self,
		_typeface: impl Into<Option<Typeface>>,
	) -> &mut Self {
		unimplemented!("This is mocked")
	}
...
impl Paint {
	...
	pub fn set_shader(
		&mut self,
		_shader: impl Into<Option<Shader>>,
	) -> &mut Self {
		unimplemented!("This is mocked")
	}
	...
	pub fn set_mask_filter(
		&mut self,
		_mask_filter: impl Into<Option<MaskFilter>>,
	) -> &mut Self {
		unimplemented!("This is mocked")
	}
}
...
impl FontCollection {
	...
	pub fn set_dynamic_font_manager(
		&mut self,
		_font_manager: impl Into<Option<FontMgr>>,
	) {
		unimplemented!("This is mocked")
...
impl ParagraphBuilder {
	...
	pub fn add_placeholder(
		&mut self,
		_placeholder_style: &PlaceholderStyle,
	) -> &mut Self {
		unimplemented!("This is mocked")
	}
	...
	pub fn new(
		...
		_font_collection: impl Into<FontCollection>,
	) -> Self {
		unimplemented!("This is mocked")
	}
}
...
pub fn set_resource_cache_single_allocation_byte_limit(
