...
use freya_node_state::{
	ConicGradient, GradientStop, LinearGradient, Parse, RadialGradient,
};
...
fn parse_conic_gradient_variants() {
	...
	assert_eq!(
		ConicGradient::parse(
			"conic-gradient(45deg, from 40deg, red 0%, blue 100%)"
		),
		Ok(ConicGradient {
			angle: Some(45.0),
	...
	assert_eq!(
		ConicGradient::parse(
			"conic-gradient(45deg, from 40deg to 120deg, red 0%, blue 100%)"
		),
		Ok(ConicGradient {
			angle: Some(45.0),
...
fn parse_rgb_hsl_gradient() {
	assert_eq!(
		LinearGradient::parse(
			"linear-gradient(0deg, rgb(255, 0, 0) 0%, blue 100%)"
		),
		Ok(LinearGradient {
			angle: 0.0,
			stops: vec![
				GradientStop { color: Color::from_rgb(255, 0, 0), offset: 0.0 },
				GradientStop { color: Color::from_rgb(0, 0, 255), offset: 1.0 }
			]
		})
	);
}
...
fn invalid_linear_gradients() {
	let incorrect_name = LinearGradient::parse(
		"lkdsjfalkasdasdjaslkfjsdklfs(red 0%, blue 100%)",
	);
	let extra_lparen =
		LinearGradient::parse("linear-gradient((red 0%, blue 100%)");
	let extra_rparen =
	...
	let bad_angle_unit =
		LinearGradient::parse("linear-gradient(45ft, red 0%, blue 100%)");
	let bad_offset_unit =
		LinearGradient::parse("linear-gradient(45deg, red 0atm, blue 100kpa)");
	let missing_color =
		LinearGradient::parse("linear-gradient(45deg, 0%, blue 100%)");
	let missing_offset =
		LinearGradient::parse("linear-gradient(45deg, red, blue 100%)");
...
fn invalid_radial_gradients() {
	let incorrect_name = RadialGradient::parse(
		"lkdsjfalkasdasdjaslkfjsdklfs(red 0%, blue 100%)",
	);
	let extra_lparen =
		RadialGradient::parse("radial-gradient((red 0%, blue 100%)");
	...
	let bad_offset_unit =
		RadialGradient::parse("radial-gradient(red 0atm, blue 100kpa)");
	let missing_color = RadialGradient::parse("radial-gradient(0%, blue 100%)");
	let missing_offset =
		RadialGradient::parse("radial-gradient(red, blue 100%)");
...
fn invalid_conic_gradients() {
	let incorrect_name =
		ConicGradient::parse("lkdsjfalkasdasdjaslkfjsdklfs(red 0%, blue 100%)");
	let extra_lparen =
		ConicGradient::parse("conic-gradient((red 0%, blue 100%)");
	let extra_rparen =
		ConicGradient::parse("conic-gradient(red 0%, blue 100%))");
	...
	let extra_commas =
		ConicGradient::parse("conic-gradient(red 0%, blue 100%,)");
	let extra_stop_component =
		ConicGradient::parse("conic-gradient(red 0% something, blue 100%)");
	let bad_angle_unit =
		ConicGradient::parse("conic-gradient(45ft, red 0%, blue 100%)");
	let bad_offset_unit =
		ConicGradient::parse("conic-gradient(red 0atm, blue 100kpa)");
	let bad_angles = ConicGradient::parse(
		"conic-gradient(45deg, from 60rft to 90fft, red 0%, blue 100%)",
	);
