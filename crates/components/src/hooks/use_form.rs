// This hook is in freya-components instead of freya-hooks because it uses some
// component props.
...
pub fn use_form<Id:Hash + Eq + Clone>(
	...
	use_hook(|| {
		UseForm { data:Signal::new(HashMap::default()), onsubmit:Signal::new(Box::new(onsubmit)) }
	})
}
