...
pub const LIGHT_THEME:Theme = Theme {
	...
	button:ButtonTheme {
		...
		font_theme:FontTheme { color:cow_borrowed!("rgb(10, 10, 10)") },
		border_fill:cow_borrowed!("rgb(210, 210, 210)"),
	...
	input:InputTheme {
		...
		hover_background:cow_borrowed!("rgb(235, 235, 235)"),
		font_theme:FontTheme { color:cow_borrowed!("rgb(10, 10, 10)") },
		placeholder_font_theme:FontTheme { color:cow_borrowed!("rgb(100, 100, 100)") },
		border_fill:cow_borrowed!("rgb(210, 210, 210)"),
	...
	loader:LoaderTheme { primary_color:cow_borrowed!("rgb(50, 50, 50)") },
	...
	table:TableTheme {
		font_theme:FontTheme { color:cow_borrowed!("black") },
		background:cow_borrowed!("white"),
		arrow_fill:cow_borrowed!("rgb(40, 40, 40)"),
	...
	graph:GraphTheme { width:cow_borrowed!("100%"), height:cow_borrowed!("100%") },
	network_image:NetworkImageTheme { width:cow_borrowed!("100%"), height:cow_borrowed!("100%") },
	icon:IconTheme {
	...
	tile:TileTheme { padding:cow_borrowed!("4 6") },
	radio:RadioTheme {
