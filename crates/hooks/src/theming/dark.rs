...
pub const DARK_THEME:Theme = Theme {
	...
	button:ButtonTheme {
		...
		font_theme:FontTheme { color:cow_borrowed!("white") },
	...
	input:InputTheme {
		...
		hover_background:cow_borrowed!("rgb(45, 45, 45)"),
		font_theme:FontTheme { color:cow_borrowed!("white") },
		placeholder_font_theme:FontTheme { color:cow_borrowed!("rgb(210, 210, 210)") },
		border_fill:cow_borrowed!("rgb(80, 80, 80)"),
	...
	loader:LoaderTheme { primary_color:cow_borrowed!("rgb(150, 150, 150)") },
	...
	graph:GraphTheme { width:LIGHT_THEME.graph.width, height:LIGHT_THEME.graph.height },
	...
	tile:TileTheme { padding:LIGHT_THEME.tile.padding },
	radio:RadioTheme {
