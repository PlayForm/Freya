...
use nokhwa::{
	pixel_format::RgbFormat, utils::RequestedFormat, Camera, NokhwaError,
};
...
pub fn use_camera(
	...
	let image_reference_attr =
		AttributeValue::any_value(CustomAttributeValues::ImageReference(
