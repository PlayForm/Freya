...
fn main() { launch_with_props(app, "freya + i18n", (300.0, 200.0)); }
...
fn app() -> Element {
	use_init_i18n(|| {
		I18nConfig::new(langid!("en-US"))
			.with_locale(Locale::new_static(langid!("en-US"), include_str!("./en-US.ftl")))
			.with_locale(Locale::new_static(langid!("es-ES"), include_str!("./es-ES.ftl")))
	});
